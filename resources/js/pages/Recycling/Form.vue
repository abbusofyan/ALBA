                            ...
                            <VCol cols="12">
                                <div class="flex items-center flex-none order-0 grow-0">
									...
									<div class="form-group">
										<v-chip color="primary me-2" v-for="waste_type in bin_type_wastes">
											{{waste_type}}
										</v-chip>
									</div>
									<!-- <v-combobox v-model="form.bin_waste_type" clearable chips multiple disabled></v-combobox> -->
                                    <!-- <div v-if="form.errors.bin_waste_type" class="invalid-feedback text-error">{{ form.errors.bin_waste_type }}</div> -->
                                </div>
                            </VCol>
