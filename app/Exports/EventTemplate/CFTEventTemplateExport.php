...
class CFTEventTemplateExport implements FromArray, WithMultipleSheets, WithEvents, WithTitle
{
    use Exportable;
    ...
    public function sheets(): array
    {
        return [
            ...
            new class($this->wasteTypes) implements FromArray, WithTitle, WithEvents {
                ...
                {
                    $rows = [];
                    $rows[] = ['Recyclables', 'Price/KG'];

                    foreach ($this->wasteTypes as $name) {
                        $rows[] = [$name, null];
                    }
